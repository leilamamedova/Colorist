(function (h, k, j) {
    function r(a) {
        if (h.event && h.event.contentOverflow !== j) return { x: h.event.offsetX, y: h.event.offsetY };
        if (a.offsetX !== j && a.offsetY !== j) return { x: a.offsetX, y: a.offsetY };
    ...
    function l(a, b, c) {
        ...
        b *= 255;
        c *= 255;
        return { r: a, g: b, b: c, hex: "#" + (16777216 | c | (b << 8) | (a << 16)).toString(16).slice(1) };
    }
    function s(a, b, c) {
        if (a > 1 || b > 1 || c > 1) {
            a /= 255;
        ...
        d = Math.max(a, b, c);
        f = d - Math.min(a, b, c);
        return { h: ((f == 0 ? null : d == a ? (b - c) / f : d == b ? (c - a) / f + 2 : (a - b) / f + 4) % 6) * 60, s: f == 0 ? 0 : f / d, v: d };
    }
    function t(a, b, c) {
        return function (d) {
            d = d || h.event;
            ...
            a.callback && a.callback(f.hex, { h: a.h - o, s: a.s, v: a.v }, { r: f.r, g: f.g, b: f.b }, j, d);
        };
    }
    function u(a, b) {
        return function (c) {
            ...
            a.v = (d - c.y) / d;
            d = l(a.h, a.s, a.v);
            a.callback && a.callback(d.hex, { h: a.h - o, s: a.s, v: a.v }, { r: d.r, g: d.g, b: d.b }, c);
        };
    }
    function i(a, b, c) {
    ...
    function q(a, b, c, d) {
        ...
        g = { x: a.s * a.pickerElement.offsetWidth, y: g - a.v * g };
        a.pickerElement.style.backgroundColor = l(a.h, 1, 1).hex;
        a.callback && a.callback(d || b.hex, { h: a.h, s: a.s, v: a.v }, c || { r: b.r, g: b.g, b: b.b }, g, f);
    }
    ...
    if (p == "SVG") {
        m = e("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", width: "100%", height: "100%" }, [
            e(
                "defs",
                {},
                e("linearGradient", { id: "gradient-hsv", x1: "0%", y1: "100%", x2: "0%", y2: "0%" }, [
                    e("stop", { offset: "0%", "stop-color": "#FF0000", "stop-opacity": "1" }),
                    e("stop", { offset: "13%", "stop-color": "#FF00FF", "stop-opacity": "1" }),
                    e("stop", { offset: "25%", "stop-color": "#8000FF", "stop-opacity": "1" }),
                    e("stop", { offset: "38%", "stop-color": "#0040FF", "stop-opacity": "1" }),
                    e("stop", { offset: "50%", "stop-color": "#00FFFF", "stop-opacity": "1" }),
                    e("stop", { offset: "63%", "stop-color": "#00FF40", "stop-opacity": "1" }),
                    e("stop", { offset: "75%", "stop-color": "#0BED00", "stop-opacity": "1" }),
                    e("stop", { offset: "88%", "stop-color": "#FFFF00", "stop-opacity": "1" }),
                    e("stop", { offset: "100%", "stop-color": "#FF0000", "stop-opacity": "1" }),
                ])
            ),
            e("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: "url(#gradient-hsv)" }),
        ]);
        n = e("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", width: "100%", height: "100%" }, [
            e("defs", {}, [
                e("linearGradient", { id: "gradient-black", x1: "0%", y1: "100%", x2: "0%", y2: "0%" }, [
                    e("stop", { offset: "0%", "stop-color": "#000000", "stop-opacity": "1" }),
                    e("stop", { offset: "100%", "stop-color": "#CC9A81", "stop-opacity": "0" }),
                ]),
                e("linearGradient", { id: "gradient-white", x1: "0%", y1: "100%", x2: "100%", y2: "100%" }, [
                    e("stop", { offset: "0%", "stop-color": "#FFFFFF", "stop-opacity": "1" }),
                    e("stop", { offset: "100%", "stop-color": "#CC9A81", "stop-opacity": "0" }),
                ]),
            ]),
            e("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: "url(#gradient-white)" }),
            e("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: "url(#gradient-black)" }),
        ]);
    } else if (p == "VML") {
        m =
